      ...
      afterReveal: function (el) {
        setTimeout(function () {
          ...
          chart.on('created', function () {
            ...
            window.__exampleAnimateTimeout = setTimeout(chart.update.bind(chart), 10870);
          });
